...
'root@localhost', 'RVU-PC-054', '8.4.6', '2025-09-29 05:59:54'
*/
...
-- Write the SQL Statement for the above Question
select department_id,count(employee_id) from employees group by department_id having count(employee_id)>10;
